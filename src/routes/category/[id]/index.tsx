...
export default component$(() => {
  ...
  return (
    <div class="max-w-screen-xl xl:mx-auto mx-2 md:mx-4 lg:mx-16">
      {heroImage && (
        <Image layout="fullWidth" aspectRatio={1} loading="lazy" decoding="async" alt="Category Logo" src={heroImage} class="h-[150px] w-[150px] mx-auto my-4 rounded-md bg-white overflow-hidden object-contain" />
      )}
